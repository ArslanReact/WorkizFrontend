                ...
                <div className="card-body shadow_box support border_radius_10">
                    ...
                    <div className="d-flex mt-4 align-items-center">
                        <div className="d-inline-flex text-center">
                            <Nav.Link href="#" className={" " + props.noimage1}><img width="40" className="img-fluid" src={props.avatar1} alt="avatar" /></Nav.Link>
                            <Nav.Link href="#" className={" " + props.noimage}><img width="40" className="img-fluid" src={props.avatar2} alt="avatar" /></Nav.Link>
                        </div>
                        <div className="ms-3">
