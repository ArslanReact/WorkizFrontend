...
import { Form, Col, Row, FormLabel, NavItem, Card } from "react-bootstrap";
            ...
            <div className="py-5">
                <div className="col-10 col-xl-11 mx-auto">
                    <div className="text-center mb-3">
                        ...
                        <p className="fontsize18 paragraph_blue_text_color">Whether you’re just getting started, or you’ve been using EasyManage for some time, here you’ll<br /> find the resources you need to become a EasyManage pro in just a few steps. </p>
                    </div>
                    <Col xl={6} className="mx-auto mb-5">
                        <div className="text-center d-flex justify-content-between">
                            <Form.Group className="d-flex align-items-center" controlId="formBasicCheckmanager">
                                <Form.Check type="radio" name="radioone" aria-label=" I’m an owner / manager" />
                                <FormLabel className="m-0 ml-2 fontweightbold blue_text_color fontsize16">I’m an owner / manager</FormLabel>
                            </Form.Group>
                            <Form.Group className="d-flex align-items-center" controlId="formBasicChecktechnician">
                                <Form.Check type="radio" name="radioone" aria-label=" I’m a technician" />
                                <FormLabel className="m-0 ml-2 fontweightbold blue_text_color fontsize16">I’m a technician</FormLabel>
                            </Form.Group>
                            <Form.Group className="d-flex align-items-center" controlId="formBasicCheckdispatcher">
                                <Form.Check type="radio" name="radioone" aria-label=" I’m a dispatcher" />
                                <FormLabel className="m-0 ml-2 fontweightbold blue_text_color fontsize16">I’m a dispatcher</FormLabel>
                            </Form.Group>
                        </div>
                    </Col>
                    {/*  */}
                    <div className="text-center">
                        <NavLink to={`${process.env.PUBLIC_URL}/signup`} className="btn btnweb d-inline-flex">Get Started</NavLink>
                    </div>
                </div>
            </div>
                ...
                <Col xl={9} lg={10} className="col-10 mx-auto">
                    <Row className="align-items-center">
                        <Col xl={5} lg={12}>
                            ...
                            <div className="d-flex align-items-center">
                                <p className="m-0 fontsize14 body_text_color mr-4"><img className="img-fluid me-2" src={videoicon} alt="icon" />7 Videos</p>
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col xl={6} lg={12}>
                            ...
                            <div className="d-flex align-items-center">
                                <p className="m-0 fontsize14 body_text_color mr-4"><img className="img-fluid me-2" src={videoicon} alt="icon" />10 Videos</p>
                    ...
                    <Row className="align-items-center">
                        <Col xl={5} lg={12}>
                            ...
                            <div className="d-flex align-items-center">
                                <p className="m-0 fontsize14 body_text_color mr-4"><img className="img-fluid me-2" src={videoicon} alt="icon" />5 Videos</p>
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col xl={6} lg={12}>
                            ...
                            <div className="d-flex align-items-center">
                                <p className="m-0 fontsize14 body_text_color mr-4"><img className="img-fluid me-2" src={videoicon} alt="icon" />4 Videos</p>
