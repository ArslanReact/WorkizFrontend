...
const EmployeeMessage = () => {
    ...
    useEffect(() => {
        axios.get(Globalsettings.url+'api/member/user-chat/'+id+'/'+companyid)
        .then((response) =>{
    ...
    const StartConversation = () => {
        setactive(true);
        axios.get(Globalsettings.url+'api/member/user-chat/create/'+id+'/'+companyid)
        .then((response) =>{ 
            setempList({empList_Array: response.data.members ? response.data.members : [],}); 
            setadminList({adminList_Array: response.data.clients ? response.data.clients : [],}); 
            setactive(false);
    ...
    const HandleMessageSend = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/member/message-submit/'+companyid+'/'+id, { 
            companyid:companyid,
            from_user_id:id,
            user_id: member,
            message: message,
    ...
    const SendMessage = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/member/message-submit/'+companyid+'/'+id, { 
            ...
            setUsersList({UsersList_Array: response.data.userList ? response.data.userList : [],});
            var url = Globalsettings.url+'api/member/user-chat/'+id+'/'+companyid;
            setenteredMassge('');
            $.ajax({
                type: 'GET',
                url: url,
