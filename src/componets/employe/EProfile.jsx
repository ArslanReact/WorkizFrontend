...
const EProfile = () => {
    ...
    const onPasswordClickShow= (e) => {
        ...
        var userid = obj.id;
        useEffect(async () => {
            await axios.get(Globalsettings.url + 'api/member/profile/' + companyid+'/'+userid)
                .then((response) => {
                    ...
                    setprofileadrress(response.data.data.EmployeeDetails.address);
                        ...
                        <Row>
                            ...
                            <Col xl={6} lg={6} className="col-12 mb-3">
                                <FormGroup className="m-0">
                                    ...
                                    <Form.Control name="" className="h-40px transparent_form" as="select" required value={gender} onChange={e => setgender(e.target.value)} >
