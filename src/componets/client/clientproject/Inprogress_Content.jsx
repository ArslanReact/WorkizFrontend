...
// 
import InprogressHistoryLoop from "../../client/clientproject/InprogressHistoryLoop";
...
function MyVerticallyCenteredModaldragfilter(props) {
    ...
    // 
    const InprogressHistoryLoop_Array = [
        {
            key: "0",
                            ...
                            <Tabs className="mt-4 filter-tabs">
                                ...
                                <TabPanel className="mt-4">
                                    ...
                                    <ul className="list-unstyled history-loop">
                                        {InprogressHistoryLoop_Array.map((val) => {
                                            return (
                                                <InprogressHistoryLoop
                                                    key={val.key}
                                                    title={val.title}
                                                    time={val.time}
                                                    avatar={val.avatar}
