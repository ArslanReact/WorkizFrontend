...
// 
import OnGoingHistoryLoop from "../../client/clientproject/OnGoingHistoryLoop";
...
function MyVerticallyCenteredModaldragfilter(props) {
    ...
    // OnGoingHistoryLoop_Array
    const OnGoingHistoryLoop_Array = [
        {
            key: "0",
                            ...
                            <Tabs className="mt-4 filter-tabs">
                                ...
                                <TabPanel className="mt-4">
                                    ...
                                    <ul className="list-unstyled history-loop">
                                        {OnGoingHistoryLoop_Array.map((val) => {
                                            return (
                                                <OnGoingHistoryLoop
                                                    key={val.key}
                                                    title={val.title}
