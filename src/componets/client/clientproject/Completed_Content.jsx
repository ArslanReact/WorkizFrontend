...
// 
import CompletedHistoryLoop from "../../client/clientproject/CompletedHistoryLoop";
...
const TaskBoard_Content = (props) => {
    ...
    return (
        <>
            <div className="card-body whitecolorbg px-0 position-relative mb-4">
                            ...
                            <Tabs className="mt-4 filter-tabs">
                                ...
                                <TabPanel className="mt-4">
                                    ...
                                    <ul className="list-unstyled history-loop">
                                        {CompletedHistoryLoop_Array.map((val) => {
                                            return (
