                    ...
                    <Form className="row mt-4">
                        ...
                        <div className="col-xl-12 col-lg-6 mb-4">
                            <Form.Group>
                                ...
                                <Form.Control type="text" as="textarea" rows={6} className="" name="" id="" placeholder="write your messager here..." />
                            </Form.Group>
                        </div>
                        <div className="col-12">
                            <Button variant="" type="button" className="d-inline-block btnweb fontsize16 drkblue_text_color">Send Message</Button>
                        </div>
                    </Form>
                </div>
            </div>
