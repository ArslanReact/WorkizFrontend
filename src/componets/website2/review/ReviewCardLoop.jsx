...
const ReviewCardLoop = (props) => {
    ...
    return (
        <>
            <Nav.Item className="col-xl-6 col-lg-12 mb-4">
                <div className="card-body white_bg_color shadow_box border_radius_15">
                    <div className="d-xl-flex d-block">
                        <div className="border_radius_10 mr-3 mb-4 mb-xl-0 overflow-hidden position-relative"><NavLink className="video-play-button" to="#" onClick={() => setnavbarModolTask(true)}><span></span></NavLink><img className="img-fluid" src={props.banner_image} alt="review_banner" /></div>
                        <div>
                            <h5 className="fontsize24">{props.title}</h5>
