                ...
                <div className="col-xl-11 col-10 mx-auto">
                    <Navbar collapseOnSelect expand="xl" className="navbarweb d-block d-lg-flex" bg="" variant="light">
                        ...
                        <Nav className="ms-auto d-none hide-nav align-items-center">
                            <Nav.Item><NavLink className="nav-link" to={`${process.env.PUBLIC_URL}/`}>Home</NavLink></Nav.Item>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3">
                                            <Nav.Item>
                                                ...
                                                <NavLink to={`${process.env.PUBLIC_URL}/expenses_management`} className="nav-link"><span><img className="img-fluid" src={arrow_right} alt="arrow_right" /></span> Expenses Management</NavLink>
                            ...
                            <Nav.Item><Link to={`${process.env.PUBLIC_URL}/demo`} className="nav-link">Demo</Link></Nav.Item>
                            <Nav.Item><Link to={`${process.env.PUBLIC_URL}/academies`} className="nav-link">Academies</Link></Nav.Item>
                            ...
                            <Nav.Item className="me-3 ms-xl-4 phone">
                                <PhoneNumber className="text_decoration_none fontsize14 drkblue_text_color fontweightbold" number={"644-872-6482"} isLinked={true} />
                            </Nav.Item>
                            <Nav.Item>
                    ...
                    <Navbar variant="light">
                        <Nav className="d-block list-unstyled">
                            ...
                            <Nav.Item className="my-4 phone">
                                ...
                                <PhoneNumber className="text_decoration_none fontsize14 d-block text-white fontweightbold" number={"644-872-6482"} isLinked={true} />
                            </Nav.Item>
                            <Nav.Item>
