...
const AddRecurringExpences = () => {
    ...
    const SubmitExpense = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/admin/expenses-recurring/store/' + companyid+'/'+userid, data).then((response) => {
            toast.success("Expense Recurring Added Successfully!");
            setLoading(false);
            setTimeout(() => { 
...
export default AddRecurringExpences;