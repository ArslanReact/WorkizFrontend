    ...
    return (
        <>
            <tr>
                ...
                <td><NavLink onClick={() => ViewExpense(props.exid)} to="#" className="blusecolortext">{props.itemname}</NavLink></td>
                <td>{props.pricename}</td>
                <td>{props.purchasedfromname}</td>
                <td><p className="blusecolortext">{props.empolyeename}</p></td>
                <td>{props.purchaseddatename}</td>
                ...
                <td className="dropdown dropdown_table">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <ul className="list-unstyled">
                            <li><NavLink to={`${process.env.PUBLIC_URL}/edit_expences/`+props.exid} className="nav-link text_decoration_none"><img className="img-fluid mr-1" src={editiconimg} alt="" /> Edit</NavLink></li>
...
export default ExpencesTableData;