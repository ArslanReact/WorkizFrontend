...
const EditExpences = (props) => {
    ...
    useEffect(() => {
        axios.get(Globalsettings.url + 'api/admin/finance/expenses/edit/' + companyid+'/'+userid+'/'+props.match.params.id)
            .then((response) => {
                ...
                setpurchasefrom(response.data.data.expense.purchase_from);
                setpurchasedate(dateFormat(response.data.data.expense.purchase_date,'yyyy-mm-dd'));
                setstatus(response.data.data.expense.status);
                setLoading(false);
    ...
    const SubmitExpense = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/admin/finance/expenses/update/' + companyid+'/'+userid+'/'+props.match.params.id, data).then((response) => {
                ...
                <div className="card card_dashboard card-body">
                    <Form onSubmit={SubmitExpense}>
                        <div className="row">
                            ...
                            <div className="col-xl-12 col-lg-12 mb-4">
                                <Button variant="" type="submit" className="w-100px btn_blue"><img className="mr-2" src={checkicon_img} alt="formtable_img" /> Update</Button>
                            </div>
                        </div>
                    </Form>
                </div>
