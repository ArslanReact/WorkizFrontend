...
const AddInvoice = () => {
    ...
    const handleSubmit = (evt) => {
        ...
        setLoading(true);
        axios.post(Globalsettings.url+'api/admin/finance/all-invoices/store/'+companyid, data).then((response) => {
            toast.success("Invoice Successfully Inserted!");
            setLoading(false);
            setTimeout(() => { 
                history.push(`${process.env.PUBLIC_URL}/invoice`);
            }, 3000)
        });
        evt.preventDefault();
    }
    ...
    function checkShippingAddress() {
        ...
        var url = Globalsettings.url+'api/admin/finance/all-invoices/check-shipping-address?showShipping='+showShipping;
        if (clientId !== '') {
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-12 mb-4">
                                ...
                                <InputGroup className="mb-0">
                                        <InputGroup.Text id="basic-addon1">{invoiceSetting.invoiceSetting_array.invoice_prefix}#{zero}</InputGroup.Text>
