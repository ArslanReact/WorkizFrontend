...
const AddPayment = () => {
    ...
    useEffect(() => {
        axios.get(Globalsettings.url + 'api/admin/finance/payments/create/' + companyid+'/'+userid)
            .then((response) => {
    ...
    const paymentsubmit = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/admin/finance/payments/store/' + companyid+'/'+userid, data).then((response) => {
    ...
    return (
        <>
            <div className="container-fluid mb-4">
                <h4 className="main_title">Add Payments</h4>
            </div>
            {/*  */}
            <div className="container-fluid mb-4">
