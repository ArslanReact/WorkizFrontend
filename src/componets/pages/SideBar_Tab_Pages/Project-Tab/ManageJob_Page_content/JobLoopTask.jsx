...
const JobLoopTask = (props) => {
    return (
        <>
            <div className="col-xl-6 col-lg-12 mb-4">
                <div className="card_dashboard card card-body tolightgraycolor2bg pb-2">
                    <div className="d-flex align-items-center dropdown for_all">
                        <p className="fontsize14 m-0">{props.top_date}</p>
                        <NavLink to="#" className="ml-auto" data-toggle="dropdown"><img className="img-fluid" src={vertical_bars} alt="" /></NavLink>
