...
const Leads_Edit = (props) => {
    ...
    useEffect(() => {
        axios.get(Globalsettings.url + 'api/admin/leads/edit/'+props.match.params.id+'/'+ companyid)
            .then((response) => {
                ...
                setcompanyname(response.data.leads.company_name);
                setwebsite(response.data.leads.website);
                setaddress(response.data.leads.address);
                setmobilenumber(response.data.leads.mobile);
                setofficenumber(response.data.leads.office_phone);
                setcity(response.data.leads.city);
                setstate(response.data.leads.state);
                setcountry(response.data.leads.country);
                setpostalcode(response.data.leads.postal_code);
                setclientname(response.data.leads.client_name);
                setclientemail(response.data.leads.client_email);
                setnextfollowup(response.data.leads.next_follow_up);
                setleadvalue(response.data.leads.value);
                setagent(response.data.leads.agent_id);
                setsource(response.data.leads.source_id);
                setleadcat(response.data.leads.category_id);
                setnote(response.data.leads.note);
    ...
    const handleSubmit = (evt) => {
        setLoading(true);
        axios.post(Globalsettings.url + 'api/admin/leads/update/'+props.match.params.id, {
            companyid: companyid,
    ...
    return (
        <>
            ...
            <div className="container-fluid mb-4">
                <h4 className="main_title">Update Lead Info</h4>
            </div>
            {/*  */}
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 mb-4">
                                ...
                                <Form.Control as="select" className="transparent_form fontsize14 h-45px" value={source} onChange={e => setsource(e.target.value)} required>
                                    ...
                                    {sourceslist.sourceslist_array.map((val, index) => {
                                        return (
                            ...
                            <div className="col mt-3">
                                <Button variant="" type="submit" className="w-100px btn_blue"><img className="img-fluid mr-2" src={checkicon} alt="" /> Update</Button>
                            </div>
                        </div>
                    </div>
                </div>
