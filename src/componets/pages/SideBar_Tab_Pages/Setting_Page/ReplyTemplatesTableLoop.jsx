...
const ReplyTemplatesTableLoop = (props) => {
...
export default ReplyTemplatesTableLoop;
    ...
    return (
        <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
            <Modal.Header closeButton className="d-flex align-items-center p-0">
                <Modal.Title id="contained-modal-title-vcenter">Update Template</Modal.Title>
            </Modal.Header>
            <Modal.Body className="p-0 mt-3">
                <Form>
                    <Form.Group>
                        <Form.Label className="mb-2">Template Heading</Form.Label>
                        <Form.Control className="transparent_form h-40px" name="" type="text" placeholder="" />
                    </Form.Group>
                    <Form.Group>
                        <Form.Label className="mb-2">Template Text</Form.Label>
