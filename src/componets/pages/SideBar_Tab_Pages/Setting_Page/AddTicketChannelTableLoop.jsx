...
const AddTicketChannelTableLoop = (props) => {
...
export default AddTicketChannelTableLoop;
    ...
    return (
        <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
            <Modal.Header closeButton className="d-flex align-items-center p-0">
                <Modal.Title id="contained-modal-title-vcenter">Update Ticket Channel</Modal.Title>
            </Modal.Header>
            <Modal.Body className="p-0 mt-3">
                <Form>
                    <Form.Group>
                        <Form.Label className="mb-2">Channel Name</Form.Label>
