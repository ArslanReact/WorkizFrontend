...
const Add_Employe = () => {
    ...
    const HandleSubmit = (evt) => {
        ...
        axios.post(Globalsettings.url + 'api/admin/employees/store', data).then(response => {
    ...
    return (
        <>
            ...
            <div className="container-fluid mb-4">
                <h4 className="main_title">Add Employee Info</h4>
            </div>
            {/*  */}
            <Form onSubmit={HandleSubmit}>
                <div className="card_dashboard card card-body mb-4 whitecolorbg">
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-3 col-lg-12 mb-4">
                            <Form.Label className="mb-2 ">Employee Email (Employee will login using this email)</Form.Label>
                            <Form.Control className="h-45px transparent_form" type="email" required value={empemail} onChange={e => setempemail(e.target.value)} />
                        </div>
                        <div className="col-xl-3 col-lg-12 mb-4">
                            <Form.Label className="mb-2 ">Password (Employee will login using this password)</Form.Label>
                            <Form.Control className="h-45px transparent_form" type="password" required minLength="6" value={emppassword} onChange={e => setemppassword(e.target.value)} />
                        ...
                        <div className="col-xl-3 col-lg-12 mb-4">
                            ...
                            <InputGroup className="d-flex">
                                ...
                                <FormControl className="h-45px transparent_form" placeholder="" value={empslack} onChange={e => setempslack(e.target.value)} />
                            </InputGroup>
                        </div>
                        <div className="col-xl-3 col-lg-12 mb-4">
                                ...
                                <div className="mb-3 p-2 bg-white text-center">
                                    {(() => {
                                        if (selectedImage) {
                                            ...
                                            return (
                                                <img width="160" className="img-thumnail" src={avatarprofile} alt="" />
                                            )
                                        }
                                    })()}
                                </div>
