...
const DesignationData = (props) => {
    const DeleteDesig = (id) => {
        props.DeleteDesig(id);
    }
    return (
        <>
            <tr>
                ...
                <td className="dropdown dropdown_table" width="80">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <ul className="list-unstyled">
                            <li><NavLink to={`${process.env.PUBLIC_URL}/manage_designation/`+ props.did} className="nav-link text_decoration_none"><img width="12" className="img-fluid mr-1" src={coggreyimg} alt="" /> Manage</NavLink></li>
                            <li><NavLink onClick={() => DeleteDesig(props.did)} to="#" className="nav-link text_decoration_none"><img className="img-fluid mr-1" src={deleteiconimg} alt="" /> Delete</NavLink></li>
                        </ul>
                    </div>
                </td>
            </tr>
