...
const Add_New_Inventory = (props) => {
    ...
    // Load Data
    useEffect(() => {
        axios.get(Globalsettings.url + 'api/admin/products/create/'+companyid)
            .then((response) => {
                setpcat({ pcat_Array: response.data.categories ? response.data.categories : [], });
                
                setptax({ ptax_Array: response.data.tax ? response.data.tax : [], });
            })
            .catch((error) => {
    ...
    const handleSubmit = (evt) => {
        setLoading(true);
        axios.post(Globalsettings.url + 'api/admin/products/store', {
            name: prodname,
            price: prodprice,
            tax: prodtax,
            ...
            toast.success("Inventory Successfully Inserted!");
            setTimeout(() => { 
    ...
    return (
        <>
            ...
            <div className="container-fluid mb-4">
                <h4 className="main_title mb-4">Add Inventory</h4>
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-12 col-lg-12 mb-4">
                                <div className="btn-group">
                                    <Button type="submit" variant="" className="w-100px btn btn_blue"><img className="img-fluid mr-2" src={checkicon} alt="" /> Save</Button>
                                </div>
                            </div>
                        </div>
                    </Form>
...
export default Add_New_Inventory;